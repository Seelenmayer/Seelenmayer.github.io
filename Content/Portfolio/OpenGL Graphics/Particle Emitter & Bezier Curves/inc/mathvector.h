/**
 * @file mathvector.h
 * @brief This file holds the vector2 and vector3 class information.
 * @author Mike K.
 * @date Dec 1st 2018
 */
...
class vector3 : public vector2{
	...
	public:
		...
		vector3() : vector2(), m_Z( 0.0f ){}

		vector3( float x, float y, float z ) : vector2( x, y ), m_Z( z ){}

		vector3( const vector2 &other ) : vector2( other ), m_Z( 0.0f ){}

		vector3( const vector3 &other ) : vector2( other ), m_Z( other.m_Z ){}
